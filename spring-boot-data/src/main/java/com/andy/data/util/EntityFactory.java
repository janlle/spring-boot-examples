...
public class EntityFactory {
    ...
    public static List<User> getUsers(Integer count) {
        ...
        for (long i = 0; i < count; i++) {
            User user = new User(null, RandomValue.getName(), RandomValue.getStr(12), RandomValue.getUser().toString(), 1 + random.nextInt(90), new Date(), false);
            userList.add(user);
        }
        return userList;
    }
    ...
    public static User getUser() {
        return new User(null, RandomValue.getName(), RandomValue.getStr(12), RandomValue.getUser().toString(), 1 + random.nextInt(90), new Date(), false);
    }
