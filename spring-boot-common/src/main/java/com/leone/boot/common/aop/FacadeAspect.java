...
import com.leone.boot.common.response.BaseResponse;
import com.leone.boot.common.response.ResponseCode;
import com.leone.boot.common.util.BeanValidator;
...
public class FacadeAspect {
    ...
    @Around("@annotation(com.leone.boot.rpc.facade.Facade)")
