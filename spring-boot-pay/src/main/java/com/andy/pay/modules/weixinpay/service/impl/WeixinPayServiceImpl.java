package com.andy.pay.modules.weixinpay.service.impl;
...
import com.andy.pay.common.constants.Constants;
import com.andy.pay.common.model.Product;
import com.andy.pay.common.utils.CommonUtil;
import com.andy.pay.modules.weixinpay.service.IWeixinPayService;
import com.andy.pay.modules.weixinpay.util.ClientCustomSSL;
import com.andy.pay.modules.weixinpay.util.ConfigUtil;
import com.andy.pay.modules.weixinpay.util.HttpUtil;
import com.andy.pay.modules.weixinpay.util.PayCommonUtil;
import com.andy.pay.modules.weixinpay.util.XMLUtil;
@Service
public class WeixinPayServiceImpl implements IWeixinPayService {
	...
	public String weixinPayH5(Product product) {
		...
		try {
			...
			value.put("type", "WAP");
			value.put("wap_url", "https://blog.52andy.pay.com");////WAP网站URL地址
