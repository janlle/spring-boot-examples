...
import com.ygoworld.ygoth.entity.User;
import com.ygoworld.ygoth.enums.ResultEnum;
import com.ygoworld.ygoth.exception.YgothException;
import com.ygoworld.ygoth.model.user.dao.UserMapper;
import com.ygoworld.ygoth.model.user.dto.SmsDTO;
import com.ygoworld.ygoth.model.user.service.UserService;
import com.ygoworld.ygoth.util.AppUtils;
import com.ygoworld.ygoth.util.CodeUtil;
import com.ygoworld.ygoth.util.JwtTokenUtil;
import org.springframework.data.redis.core.RedisTemplate;
import org.springframework.data.redis.core.StringRedisTemplate;
import org.springframework.web.client.RestTemplate;
import org.thymeleaf.context.Context;
import org.thymeleaf.context.IContext;
import com.ygoworld.ygoth.model.user.service.MessageService;
...
public class MessageService {
    ...
    @Value("${ygoth.mail.mailTemplate}")
    private String template;

    @Value("${ygoth.sms.provicerUrl}")
    ...
    public boolean sendSms(String to) throws RuntimeException {
        ...
        if (result != null) {
            if (result.getError_code() == 0){
                ...
                throw new YgothException(ResultEnum.GET_VALIDATE_CODE_ERROR);
            }
        }
        try {
    ...
    public void activateSms(String phone, String code) throws RuntimeException {
        if (phone != null && code != null) {
            ...
            if (result == null) {
                ...
                throw new YgothException(ResultEnum.VALIDATE_CODE_EXPIRED);
            }
            if (!result.equals(code)){
                log.error("输入的验证码有误,原始验证码为：{}，输入验证码为：{}", result, code);
                throw new YgothException(ResultEnum.CODE_MISMATCHING);
            }
        }
