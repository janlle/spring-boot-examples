...
public class RandomValue {
    ...
    private static final String[] urls = {"http://www.baidu.com",
            "http://www.github.com",
            "http://www.google.com",
            "http://www.taobao.com",
    ...
    private static final String firstName[] = {
            ...
            "江", "于", "时", "傅", "皮", "卞", "齐", "康", "伍", "余", "元", "卜", "顾", "孟", "平", "黄",
            "和", "穆", "萧", "尹", "姚", "邵", "湛", "汪", "祁", "毛", "禹", "狄", "米", "贝", "明", "臧",
            "计", "伏", "成", "戴", "谈", "宋", "茅", "庞", "熊", "纪", "舒", "屈", "项", "祝", "董", "梁",
            "杜", "阮", "蓝", "闽", "席", "季", "麻", "强", "贾", "路", "娄", "危", "江", "童", "颜", "郭",
            "梅", "盛", "林", "陈", "谭", "徐", "丘", "骆", "高", "夏", "蔡", "田", "樊", "胡", "凌", "霍"};
    ...
    private static final String[] email_suffix = "@gmail.com,@yahoo.com,@msn.com,@aol.com,@ask.com,@live.com,@qq.com,@0355.net,@163.com,@163.net,@263.net,@3721.net,@yeah.net,@googlemail.com,@126.com,@sina.com,@sohu.com,@yahoo.com.cn".split(",");
    ...
    public static String randomTel() {
        ...
        return first + "3987910" + random.nextInt(10);
