...
public abstract class RandomValue {
    ...
    private static final String FULL_DATE_PRETTY = "yyyy-MM-dd hh:mm:ss";

    private static final String DATE_PRETTY = "yyyy-MM-dd";

    private static final String TIME_PRETTY = "hh:mm:ss";
    ...
    private static final String[] TEL_OTHER = "2349,0985,1235,0867,1252,0956,1567,1573,0984,1252,2098,5087,3091,9122".split(",");
     ...
     * @return
     */
    public static int randomInt(Object[] arr) {
    ...
    public static String randomTel() {
        return TEL_FIRST[randomInt(TEL_FIRST)] + TEL_OTHER[randomInt(TEL_OTHER)] + TEL_OTHER[randomInt(TEL_OTHER)];
    }
    ...
    public static String randomUsername() {
        StringBuilder sb = new StringBuilder(FIRST_NAME[randomInt(FIRST_NAME)]);
    ...
    public static String randomWords() {
        return MESSAGES[randomInt(MESSAGES)];
    }
    ...
    public static String randomNum(Integer length) {
        ...
        for (int i = 0; i < length; i++) {
            result.append(NUMBERS[randomInt(NUMBERS)]);
        }
    ...
    public static String randomUrl() {
        StringBuilder sb = new StringBuilder();
        sb.append(URL_PREFIX[RANDOM.nextInt(2)]).append(randomLetter(RANDOM.nextInt(5) + 3)).append(URL_SUFFIX[randomInt(URL_SUFFIX)]);
        return sb.toString();
    }
    ...
    public static String randomDriver() {
        return DRIVER[randomInt(DRIVER)];
    }
    ...
    public static String randomTime() {
        Instant instant = randomDateTime().toInstant();
        ZonedDateTime zonedDateTime = instant.atZone(ZoneId.systemDefault());
        return zonedDateTime.format(DateTimeFormatter.ofPattern(DATE_PRETTY));
    }
    ...
    public static String randomDate() {
        Instant instant = randomDateTime().toInstant();
        ZonedDateTime zonedDateTime = instant.atZone(ZoneId.systemDefault());
        return zonedDateTime.format(DateTimeFormatter.ofPattern(TIME_PRETTY));
    }
    ...
    public static Date randomDateTime() {
        return new Date(RANDOM.nextInt((int) (System.currentTimeMillis() / 1000)) * 1000L);
    }
    ...
    public static String randomIDCard() {
        ...
        // 18 随机生成校验码
        String check = CHECKS[randomInt(CHECKS)];
        // 拼接身份证号码
    ...
    public static String randomUserAgent() {
        return USER_AGENT[randomInt(USER_AGENT)];
    }
